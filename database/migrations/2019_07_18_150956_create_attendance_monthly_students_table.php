...
class CreateAttendanceMonthlyStudentsTable extends Migration
{
   /**
    * Run the migrations.
    *
   ...
   public function up()
   {
      Schema::create('attendance_monthly_students', function (Blueprint $table) {
         $table->increments('id');
   ...
   {
      Schema::dropIfExists('attendance_monthly_students');
   }
}
