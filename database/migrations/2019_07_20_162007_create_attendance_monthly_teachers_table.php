...
class CreateAttendanceMonthlyTeachersTable extends Migration
{
   /**
    * Run the migrations.
    *
   ...
   public function up()
   {
      Schema::create('attendance_monthly_teachers', function (Blueprint $table) {
         $table->increments('id');
   ...
   {
      Schema::dropIfExists('attendance_monthly_teachers');
   }
}
