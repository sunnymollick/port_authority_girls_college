...
@section('content')
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <p class="panel-title"> All Sliders
                        @can('stdclass-create')
    ...
    <script>
        $(function () {
            table = $('#manage_all').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.allSliders.sliders') !!}',
                columns: [
    ...
    <script type="text/javascript">
        ...
        function create() {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('Add New Slider'); // Set Title to Bootstrap modal title
        ...
        $("#manage_all").on("click", ".view", function () {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('View Slider'); // Set Title to Bootstrap modal title
