...
@section('content')
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <p class="panel-title"> All Events
                        @can('event-calender-create')
    ...
    <script>
        $(function () {
            table = $('#manage_all').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.allEvents.events') !!}',
                columns: [
    ...
    <script type="text/javascript">
        ...
        function create() {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('Add New Event'); // Set Title to Bootstrap modal title
