...
@section('content')
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <p class="panel-title"> All Expenses
                        @can('stdclass-create')
        ...
        $(function () {
            table = $('#manage_all').DataTable({
                ...
                buttons: [
                    ...
                    {
                        extend: 'print',
                        title: "<div class='text-center'>{!! $app_settings->name  !!} <br/> All Expenses <br/> Session : {!! $app_settings->running_year  !!} </div>",
    ...
    <script type="text/javascript">
        ...
        $("#manage_all").on("click", ".edit", function () {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('Edit Expenses'); // Set Title to Bootstrap modal title
        ...
        $("#manage_all").on("click", ".view", function () {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('View Expenses'); // Set Title to Bootstrap modal title
