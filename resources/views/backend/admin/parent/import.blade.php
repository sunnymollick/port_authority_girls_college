        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <p class="panel-title"> Import Parents
                        <a style="color: #fff" href="{{ asset('assets/documents/parent_import_file.xlsx') }}"
                ...
                <div class="panel-body">
                    <div class="row">
                        <form id='create' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            <div id="status"></div>
                            <div class="col-md-12">
                                <label for="excel_upload">Import Parents</label>
                    ...
                    <div class="row">
                        <div class="col-md-12 import_notice">
                            <p> Please Follow The Instructions While Importing Parents: </p>
                            <ol>
                                <li>At first download excel demo file.</li>
                                <li>Please do not edit or delete heading column.</li>
                                <li>You must have to add unique parent code or same as student code, email address</li>
                                <li>Browse the saved file.</li>
                                <li>Hit "Import" Button and wait untill success message.</li>
                            </ol>
                            <span>
                                ***This System Keeps Track Of Duplication In Email and Parent Code. So Please Enter
                                Unique Email ID
                                and Parent Code For Every Parents. </span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            $('#create').validate({// <- attach '.validate()' to your form
                ...
                submitHandler: function (form) {
                    ...
                    swal({
                        ...
                        $.ajax({
                            url: '{!! route('admin.importParents.import') !!}',
                            type: 'POST',
                            data: myData,
                            dataType: 'json',
                            cache: false,
