            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="idcard">
                    <div class="col-md-offset-3 col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="card_logo">
                                    <img src="{{ asset($app_settings->favicon) }}" width="80px"/>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-md-12 signature pull-right" style="margin-top: -30px;">
                                    <p class="text-right">
                                        <img style="border: none;" src="{{ asset('assets/images/head_master.jpg') }}"
                ...
                <div class="row"><br/><br/>
                    <div class="col-md-12 import_notice">
                        <p> Please Follow The Instructions While Generating ID Card: </p>
                        <ol>
                            <li>Upload logo from setting menu upload a favicon</li>
                            <li>Change title from settings menu</li>
                            <li>Import/Insert Student parent infromation from parent menu to display parent
                                infromation
                            </li>
                            <li>change website link, address from settings menu</li>
                            <li>Change student infromation from student menu</li>
                        </ol>
                    </div>
                </div>
            </div>
