...
@section('title', 'Promotion Students')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <p class="panel-title"> Students Promotion
                        <a style="color: #fff" href="{{ asset('assets/documents/student_promotion_file.xlsx') }}"
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 import_notice">
                            <p> Please Follow The Instructions While Promoting Students: </p>
                            <ol>
                                ...
                                <li>You must have to add student code from student table</li>
                            ...
                            Import process first check student exist or not, if already exist it will ignore promotion if not exists it will promote student to class with new enrollment.
            ...
            $('#create').validate({// <- attach '.validate()' to your form
                ...
                submitHandler: function (form) {
                    ...
                    swal({
                        ...
                        $.ajax({
                            url: '{!! route('admin.importPromotion.import') !!}',
                            type: 'POST',
                            data: myData,
                            dataType: 'json',
                            cache: false,
