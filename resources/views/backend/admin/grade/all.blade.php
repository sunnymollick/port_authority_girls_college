...
@section('content')
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <p class="panel-title"> All Grades
                        @can('stdclass-create')
    ...
    <script>
        $(function () {
            table = $('#manage_all').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.allGrades.grades') !!}',
                columns: [
    ...
    <script type="text/javascript">
        ...
        function create() {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('Add New Grade'); // Set Title to Bootstrap modal title
        ...
        $("#manage_all").on("click", ".edit", function () {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('Edit Grade'); // Set Title to Bootstrap modal title
