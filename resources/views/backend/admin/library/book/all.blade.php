...
@section('content')
    ...
    <script>
        $(function () {
            table = $('#manage_all').DataTable({
                ...
                serverSide: true,
                pageLength: 50,
                ajax: '{!! route('admin.allBooks.books') !!}',
                columns: [
    ...
    <script type="text/javascript">
        ...
        function create() {
            $("#modal_data").empty();
            $('.modal-title').text('Add New Books'); // Set Title to Bootstrap modal title
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#manage_all").on("click", ".delete", function () {
                ...
                swal({
                    title: "Are you sure?",
                    text: "Deleting of a book can delete all related books request.",
                    type: "warning",
