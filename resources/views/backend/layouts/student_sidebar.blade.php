...
<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview">
            <a href="{{ URL :: to('/student/optionalSubject') }}">
                <i class="fa fa-book"></i> <span>Optional Subject</span>
            </a>
        </li>
        <li class="treeview">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a href="{{ URL :: to('/student/admitCard') }}">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a href="{{ URL :: to('/student/feeBooks') }}">
                        <i class="fa fa-print"></i> <span>Print Fee Books </span></a>
                </li>
                <li><a href="{{ URL :: to('/student/paymentHistory') }}">
                        <i class="fa fa-list"></i> <span>Payment Reports </span></a>
                </li>
            </ul>
        </li>
        <li>
