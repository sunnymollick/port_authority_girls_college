        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#parent" data-toggle="tab" aria-expanded="true">Parent
                            Information</a></li>

                    <li class=""><a href="#student" data-toggle="tab" aria-expanded="false">Students Information</a>
                    </li>
                </ul>
